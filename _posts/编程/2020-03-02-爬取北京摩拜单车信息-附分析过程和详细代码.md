...
categories:
  - "编程"
permalink: "/2020-03-02/爬取北京摩拜单车信息-附分析过程和详细代码.html"
---
# 公众号
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090149.jpg)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090207.jpg)

获取附近单车信息的接口是：http://app.mobike.com/api/nearby/v3/nearbyBikeInfo

同时 response 是个 json，解析出来是这样的：

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090229.jpg)

其中包括 bike 和 mpl 数组，bike 即为最终要获取的单车详细信息，结构如下：

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090240.jpg)

而 mpl 应该是摩拜推出的新功能，表示「停车地点」，在这些地点停车有机会获得 NIKE 新春贺礼 85 折优惠券，结构如下：

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090253.jpg)

## 经纬度查询

在 Fiddler 中抓取 request 发现纬度和经度分别为：39.977524，116.305863，通过[经纬度查询的网站][5]发现定位极其精准：

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090312.jpg)

查询 response 中 mpl 信息的一个地址：39.975823, 116.305252

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090324.jpg)

发现确实是地图上的位置：

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090336.jpg)

## Postman 验证

把请求参数放到 postman 中，发现能够直接给出结果：

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090348.jpg)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090415.jpg)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-03-02-090508.jpg)
