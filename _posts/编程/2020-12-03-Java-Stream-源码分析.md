...
tags:
  - "Java"
permalink: "/2020-12-03/Java-Stream-源码分析.html"
---
- [前言](#前言)
- [操作分类](#操作分类)
- [源码结构](#源码结构)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-030958.jpg)

# 源码结构

Stream 相关类和接口的继承关系如下图所示：

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-031525.jpg)

## BaseStream

最顶端的接口类，定义了流的基本接口方法，最主要的方法为 spliterator、isParallel。

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-032745.png)

## Stream

最顶端的接口类。定义了流的常用方法，例如 map、filter、sorted、limit、skip、collect 等。

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-032941.png)

## ReferencePipeline

ReferencePipeline 是一个结构类，定义内部类组装了各种操作流，定义了 `Head`、`StatelessOp`、`StatefulOp` 三个内部类，实现了 BaseStream 与 Stream 的接口方法。

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-033157.png)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-033401.png)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-065103.png)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-070838.png)

对于第二个元素 “java”，predicate.test 会返回 true（字符串“java” 的长度<=4），则会进入 map 的 accept 方法。

![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-071448.png)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-074737.jpg)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-074833.jpg)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-074848.jpg)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-074906.jpg)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-074920.jpg)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/2020-12-03-074933.jpg)
