---
layout: post
title: "Redis 源码简洁剖析 08 - epoll"
date: 2022-02-05
categories:
  - "编程"
tags:
  - "Redis 源码剖析系列"
permalink: "/2022-02-05/Redis-源码简洁剖析-08-epoll.html"
---
# IO 多路复用

关于 select, poll, epoll，[​网络 IO 演变发展过程和模型介绍](https://mp.weixin.qq.com/s/EDzFOo3gcivOe_RgipkTkQ) 这篇文章讲得很好，本文就不浪费笔墨了。

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/2024-02-19-11-29-26.png)

Redis 针对不同操作系统，选择不同的 IO 多路复用机制，具体代码在 `ae.c`。
