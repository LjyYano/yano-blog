...
tags:
  - "Redis 源码剖析系列"
permalink: "/2022-02-06/Redis-源码简洁剖析-10-aeEventLoop-及事件.html"
---
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220207103202.png?x-oss-process=style/yano)

## 写事件处理

readQueryFromClient 函数在 `networking.c` 中，收到客户端请求后，处理客户端命令，并将返回的数据写入客户端输出缓冲区。

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220207171803.png?x-oss-process=style/yano&x-oss-process=style/yano)
