...
tags:
  - "Redis 源码剖析系列"
permalink: "/2022-02-02/Redis-源码简洁剖析-05-ziplist-压缩列表.html"
---
...
- [ziplist 基本操作](#ziplist-基本操作)
  ...
  - [将节点添加到末端](#将节点添加到末端)
  - [将节点添加到某个 / 某些节点的前面](#将节点添加到某个--某些节点的前面)
  - [删除节点](#删除节点)
- [参考链接](#参考链接)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220203102540.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220204085123.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220204085734.png)

表格中的下划线 _ 表示留空，而变量 b 、 x 等则代表实际的二进制数据。为了方便阅读，多个字节之间用空格隔开。

11 开头的整数编码如下：

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220204085805.png)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220203104757.png)
