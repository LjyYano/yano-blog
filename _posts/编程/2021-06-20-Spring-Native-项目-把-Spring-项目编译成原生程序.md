...
tags:
  - "Spring"
permalink: "/2021-06-20/Spring-Native-项目-把-Spring-项目编译成原生程序.html"
---
...
![Specific Languages 1](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210325144139.png?x-oss-process=style/yano)

![Specific Languages 2](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210325144402.png?x-oss-process=style/yano)

## 关键特性

![关键特性](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210325144431.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210325144533.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210325154902.png?x-oss-process=style/yano)
...
![启动时间](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210325155102.png?x-oss-process=style/yano)
...
![报错 1](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210325152452.png?x-oss-process=style/yano)

### 内存问题

若编译时遇到下面的情况，是 OOM 问题，需要把 Docker 的内存改大（8G）。

![报错 2](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210325152601.png?x-oss-process=style/yano)

以 Mac 的 Docker Client 设置为例：

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/B241FBEC-2B1B-4F18-A1EE-891C921272A1.png?x-oss-process=style/yano)
