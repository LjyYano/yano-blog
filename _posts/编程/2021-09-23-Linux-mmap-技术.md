...
categories:
  - "编程"
permalink: "/2021-09-23/Linux-mmap-技术.html"
---
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210923102846.png?x-oss-process)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210923103051.png?x-oss-process)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210923103151.png?x-oss-process)

虚拟内存被分为`用户空间`和`内核空间`两部分：进程在用户态时，只能访问用户空间；进入内核态，才能访问内核空间。我们看一下 32 位地址和 64 位地址空间的分布：

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210923103421.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210923140321.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210923140548.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20210923141137.png?x-oss-process)
