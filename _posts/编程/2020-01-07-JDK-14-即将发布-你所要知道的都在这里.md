---
layout: post
title: "JDK 14 即将发布，你所要知道的都在这里！"
date: 2020-01-07
categories:
  - "编程"
tags:
  - "Java"
permalink: "/2020-01-07/JDK-14-即将发布-你所要知道的都在这里.html"
---
[toc]
...
G1 的堆内存是固定大小的 `region` 的集合。一个 region 通常是一组物理页面，尽管在使用大页面（通过 - XX:+UseLargePages 设定）时，一个物理页面由多个 region 组成。
