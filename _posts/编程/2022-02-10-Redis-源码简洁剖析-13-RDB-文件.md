---
layout: post
title: "Redis 源码简洁剖析 13 - RDB 文件"
date: 2022-02-10
categories:
  - "编程"
tags:
  - "Redis 源码剖析系列"
permalink: "/2022-02-10/Redis-源码简洁剖析-13-RDB-文件.html"
---
- [RDB 是什么](#rdb-是什么)
- [RDB 文件格式](#rdb-文件格式)
  - [Header](#header)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/
20220218175013.png?x-oss-process=style/yano)

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220218174914.png)

# RDB 文件格式

详细信息可参考：[Redis RDB Dump File Format](https://github.com/sripathikrishnan/redis-rdb-tools/wiki/Redis-RDB-Dump-File-Format)。

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220218174944.png)

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220214194237.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220214195122.png)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220215104928.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220214200607.png?x-oss-process=style/yano)

本篇文章只是分析 rdb 文件的基本结构和格式，只保存了一个最基础的 string。（图画了一个小时😁）RDB 这块的 Redis 源码就不分析了，基本上都是按照这个结构来的。

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220214112526.png?x-oss-process=style/yano)

![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220214194952.png?x-oss-process=style/yano)
