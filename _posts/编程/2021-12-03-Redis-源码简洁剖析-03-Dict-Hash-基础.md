...
tags:
  - "Redis 源码剖析系列"
permalink: "/2021-12-03/Redis-源码简洁剖析-03-Dict-Hash-基础.html"
---
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220127165830.png)
...
整体的哈希流程都是老生常谈了，和 Java 几乎是一样的，这里就不赘述了。

# Redis rehash 原理

## 为什么要 rehash？

为了 ` 性能 `。如果哈希表 bucket 的数量是 1，但是里面有了 1000 个元素，不管怎么样都变成了一个链表，查询效率变得很低。同理，当哈希表里元素的个数比 bucket 数量多很多的时候，效率也会低很多。
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220127164235.png?x-oss-process=style/yano)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220127174032.png)
...
![](https://yano.oss-cn-beijing.aliyuncs.com/blog/20220128104019.png)
